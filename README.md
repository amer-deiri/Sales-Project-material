...
<a> (https://github.com/amer-deiri/Sales-Project-material/blob/main/Dashboard.png) </a>
### Dataset Used :
...
-  __emp info.xlsx__: Sales rep information (80 reps) including ID, Name, Date of Birth, Hiring Date, Band, and Marital Status.
-  __regions.xlsx__: 7 regions with IDs and names (e.g., Northeast: 3001).
-  __channels & segmant.xlsx__: Channels (4 types with IDs) and Segments (Business: 5001, Consumer: 5002).
